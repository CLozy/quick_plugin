"""
Django settings for quickplugin project.
...
SECRET_KEY = 'django-insecure--4jj6ag_4*tj_ydx)db(iai&)a_2xnfe%9&vzn@6+vj57*&45@'
...
AUTH_USER_MODEL = 'fastexcel.CustomUser'
